...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\桌面文件\\zhongjian_bao\\zhongjianbao-api\\src\\main\\java\\com");
        gc.setAuthor("HENRYC");
        ...
        dsc.setUrl("jdbc:mysql://47.99.80.133:3306/zhongjian_bao?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
...
//        pc.setModuleName("sys");
        pc.setParent("zhongjianbaoapi");//controller entity  service  service.impl
