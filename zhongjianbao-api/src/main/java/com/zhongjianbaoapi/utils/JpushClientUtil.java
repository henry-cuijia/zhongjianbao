...
public class JpushClientUtil {
    ...
    private static String MasterSecret = "7bd2ad4eb485421b743d126b";
    private static String AppKey = "8f5f331987c421dfd36f0f6f";

    private static final Logger logger = LoggerFactory.getLogger(JpushClientUtil.class); //打印日志
    ...
    public static String sendToRegistrationId(String id, String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        String result = "fail";
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_all_registrationId_alertWithTitle(id, notification_title, msg_title, msg_content, extrasparam);
    ...
    public static String sendToRegistrationIdMsg(String id, String notification_title, String extravalue, String msg_content, Map<String,String> extrasparam) {
        String result = "fail";
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_all_registrationId_alertWithTitleMsg(id, notification_title, extravalue, msg_content, extrasparam);
            PushResult pushResult = jPushClient.sendPush(pushPayload);
            if (pushResult.getResponseCode() == 200) {
                result = "success";
            }
    ...
    public static String sendToAllAndroid(String id, String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        String result = "fail";
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_android_all_alertWithTitle(id,notification_title, msg_title, msg_content, extrasparam);
    ...
    public static int sendToAllIos(String id, String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_ios_all_alertWithTitle(id,notification_title, msg_title, msg_content, extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult = jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if (pushResult.getResponseCode() == 200) {
    ...
    public static int sendToAll(String id, String notification_title, String msg_title, String msg_content, Map<String,String> extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_android_and_ios(id,notification_title, msg_title, msg_content, extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult = jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if (pushResult.getResponseCode() == 200) {
